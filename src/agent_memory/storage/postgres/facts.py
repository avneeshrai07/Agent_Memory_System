...
Structurally satisfies agent_memory.storage.interfaces.FactStore — Protocol
...
from agent_memory.models import MemoryFact, MemoryStatus, ScoredFact
...
class PostgresFactStore:
    ...
    async def search_facts(
        ...
        not here, per agent_memory.storage.interfaces.FactStore.
        """
        async with self._pool.acquire() as conn:
